...
const DashboardPage = () => {
  ...
  const handleUpdate = async () => {
    try {
      ...
      setServices((prev) =>
        prev.map((service) =>
          service.id === editingService.id ? res.data : service
        )
      );
    ...
    <div className="min-h-screen bg-[#fafafa]">
      <div className="max-w-7xl mx-auto px-4 sm:px-5 py-8">
        <div className="relative overflow-hidden rounded-3xl sm:rounded-4xl bg-linear-to-br from-violet-700 via-violet-600 to-fuchsia-500 p-6 sm:p-10 text-white">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:justify-between gap-8 text-center lg:text-left items-center lg:items-start">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-violet-100 text-base sm:text-lg leading-relaxed">
                Edit, update and manage your professional listings all in one place.
              </p>
            </div>
            ...
            <div className="flex justify-center lg:justify-end w-full lg:w-auto">
              <button
                ...
                className="h-12 sm:h-14 px-5 sm:px-6 rounded-2xl bg-white text-violet-700 font-semibold flex items-center justify-center gap-2 hover:bg-violet-50 transition shadow-xl"
              >
                <Plus size={20} />
                New Service
              </button>
        ...
        {loading ? (
          ...
          <div className="mt-8 bg-white border border-gray-200 rounded-3xl sm:rounded-4xl p-10 sm:p-12 text-center">
            <div className="w-20 h-20 mx-auto rounded-3xl bg-violet-100 flex items-center justify-center">
              <Plus className="text-violet-700" />
            </div>

            <h3 className="mt-6 text-2xl font-bold text-gray-900">No services yet</h3>

            <p className="mt-3 text-gray-500 max-w-md mx-auto">
              Start building your presence on Servio by creating your first service listing.
            </p>
          ...
          <div className="mt-8 grid sm:grid-cols-2 xl:grid-cols-3 gap-6">
            {services.map((service) => (
              <div
                key={service.id}
                className="group bg-white border border-gray-200 rounded-3xl sm:rounded-[30px] p-5 sm:p-6 hover:-translate-y-1 hover:shadow-2xl hover:shadow-gray-200 transition duration-300"
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-4">
                      <button
                        onClick={() => navigate(`/users/${service.username}`)}
                      ...
                      >
                        {service.profile_image ? (
                          ...
                          <div className="w-11 h-11 rounded-full bg-linear-to-br from-violet-600 to-fuchsia-500 flex items-center justify-center text-white font-bold shadow-md">
                    ...
                    <h2 className="mt-3 text-xl sm:text-2xl font-bold text-gray-900 leading-tight line-clamp-2">
                      {service.title}
                    </h2>
                  </div>

                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-linear-to-br from-violet-600 to-fuchsia-500 flex items-center justify-center text-white font-bold shadow-lg shrink-0">
                ...
                <div className="mt-6 pt-5 border-t border-gray-100 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                  <div>
                  ...
                  <div className="flex items-center gap-2 justify-end flex-wrap">
                    <button
                      ...
                      className="w-10 h-10 sm:w-11 sm:h-11 rounded-2xl border border-gray-200 flex items-center justify-center text-gray-600 hover:bg-gray-50 transition"
                    >
                      <Eye size={18} />
                    </button>
                    ...
                    <button
                      ...
                      className="w-10 h-10 sm:w-11 sm:h-11 rounded-2xl border border-gray-200 flex items-center justify-center text-gray-600 hover:bg-violet-50 hover:text-violet-700 hover:border-violet-200 transition"
                    >
                      <Pencil size={18} />
                    </button>
                    ...
                    <button
                      ...
                      className="w-10 h-10 sm:w-11 sm:h-11 rounded-2xl border border-gray-200 flex items-center justify-center text-gray-600 hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition"
                    >
                      <Trash2 size={18} />
                    </button>
                  </div>
        ...
        {editingService && (
          <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="w-full max-w-2xl bg-white rounded-3xl sm:rounded-4xl p-5 sm:p-8 max-h-[90vh] overflow-y-auto">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Edit service</h2>
