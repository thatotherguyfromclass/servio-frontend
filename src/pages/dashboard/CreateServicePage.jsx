      ...
      <div className="max-w-5xl mx-auto px-5 py-8">
        <div className="relative overflow-hidden rounded-4xl bg-linear-to-br from-violet-700 via-violet-600 to-fuchsia-500 p-8 sm:p-10 text-white">
          ...
          <div className="relative z-10 flex items-start gap-5">
            <div className="w-16 h-16 rounded-3xl bg-white/15 backdrop-blur-md flex items-center justify-center shrink-0 border border-white/10">
            ...
            <div>
              ...
              <p className="mt-4 text-violet-100 text-base sm:text-lg leading-relaxed max-w-2xl">
                Publish your service on
                Servio and connect with
        ...
        <div className="mt-8 bg-white border border-gray-200 rounded-4xl p-6 sm:p-8 shadow-sm">
          <form
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Describe your service, experience, pricing and what clients should expect..."
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
              <p className="text-sm text-gray-500">
                Your service will be visible
                to users searching in your
                area.
              </p>
